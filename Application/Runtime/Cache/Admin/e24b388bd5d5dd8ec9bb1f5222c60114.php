            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header bg-info">
                        ...
                        <a class="btn btn-info pull-right btn-sm" href="<?php echo U('Project/add?p='.I('get.p'));?>"><i class="fa fa-plus-square"></i> 添 加</a>
                    </div>
                    
                    <div class="col-md-6">
                        <form action="/index.php/Admin/Project/search" method="GET">
                            <div class="box-body">
