...
<!--        <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="<?php echo U('Admin/Admin/addUser');?>">
...
<div class="content-wrapper">
    ...
    <section class="content">
        <form class="form" action="/index.php/Admin/Admin/addUser.html" method="POST">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="pw" class="form-control" placeholder="请输入密码">
                                </div> 
                            </div>
                            <div class="form-group">
                                <label>确认密码</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" name="rpw" class="form-control" placeholder="请再次输入密码">
                                </div> 
                            </div>
                            <div class="form-group">
                                <label>员工姓名</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" name="header" class="form-control" placeholder="请输入员工姓名">
                                </div> 
                            </div>
                            <div class="form-group">
                                <label>工号</label>
