                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="appointment_time" class="form-control" id="datetime" value="<?php echo $evData['repair_time'];?>">
                                </div> 
                            </div>
                            <div class="form-group">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(data).each(function (k, v) {
                    html += '<tr><th>' + v.part_name + '：</th>' + '<th><input type="text"  name="part_fee['+ v.id +']" value="' + v.out_price + '"></th><th>*<input type="text" name="part_number[]" value="1"></input></th></tr>';
                });
                $("#part").html(html);
            }
        });
