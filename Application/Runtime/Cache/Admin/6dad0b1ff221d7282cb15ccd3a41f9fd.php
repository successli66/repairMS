...
<div class="content-wrapper">
    ...
    <section class="content">
        <form class="form" action="/index.php/Repair/edit_end/repair_id/18/p/index.html" method="POST">
            <div class="box box-info">
                <div class="box-header bg-info">
                    <h3 class="box-title">办结说明</h3>    
                    <a class="btn btn-info pull-right btn-sm" id="cancelBtn" href="<?php echo U('cancel',array('repair_id'=>I('get.repair_id'),'p'=>I('get.p')));?>"><i class="fa fa-times-rectangle-o"></i> 取消办结</a>
                ...
                <div class="box-body bg-info">
                    ...
                    <div class="row">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label>办结详情</label>
                                <textarea id="descr" name="descr"><?php echo $evData['descr'];?> </textarea>
                            </div>
                        </div>
                        <div class="col-md-2"></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <button type="submit" class="btn btn-default"><i class="fa fa-send"></i>  确认修改</button>
                            <a href="<?php echo U('info',array('id'=>I('get.repair_id'),'p'=>I('get.p')));?>" type="button" class="btn btn-default"><i class="fa fa-times"></i> 取消修改</a>
                        </div>
                    </div>
                </div>
            </div>
