                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker"  id="parent_id" name="parent_id" data-live-search="true">
                                    ...
                                    <option value="<?php echo $v['id'];?>"><?php echo str_repeat('-',6*$v['level']).$v['privilege_name'];?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="privilege_name" class="form-control" placeholder="请输入名称">
                                </div> 
                            </div>
                            <div class="form-group">
                                <label> 模块名称</label>
                                <div class="input-group">
                                    ...
                                    <div id="module_name">
                                        <input type="text" name="module_name" class="form-control" placeholder="请输入名称">
                                    </div>
                                </div> 
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div id="controller_name">
                                        <input type="text"  name="controller_name" class="form-control" placeholder="请输入名称">
                                    </div>
                                </div> 
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="action_name" class="form-control" placeholder="请输入名称">
                                </div> 
                            </div>
                        </div>
                    </div>
