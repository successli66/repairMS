            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header">
                        ...
                        <a class="btn btn-info pull-right btn-sm" href="<?php echo U('Company/add');?>"><i class="fa fa-plus-square"></i> 添 加</a>
                    </div>
                    <div class="col-md-5">
                        <div class="box-body">
                            <div class="input-group margin">
                                <input type="text" class="form-control" placeholder="输入公司名称搜索...">
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-info btn-flat"><i class="fa fa-search"></i> 搜 索</button>
                                </span>
                            </div>        
                        </div>
                    </div>
